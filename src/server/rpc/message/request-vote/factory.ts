...
export function createRequestVoteRpcRequest(args: IRequestVoteRpcArguments): IRequestVoteRpcRequest {
    return {
        callType: 'request',
...
export function createRequestVoteRpcResponse(results: IRequestVoteRpcResults): IRequestVoteRpcResponse {
    return {
        callType: 'response',
        procedureType: 'request-vote',
        results
