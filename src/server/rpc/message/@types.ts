import { IAppendEntriesRpcRequest, IAppendEntriesRpcResponse } from './append-entries';
import { IRequestVoteRpcRequest, IRequestVoteRpcResponse } from './request-vote';
...
export type IRpcRequestTypeFilter<P extends IRpcMessage['procedureType']> =
    P extends 'append-entries' ? IAppendEntriesRpcRequest :
    P extends 'request-vote' ? IRequestVoteRpcRequest :
    never;
...
export type IRpcResponseTypeFilter<P extends IRpcMessage['procedureType']> =
    P extends 'append-entries' ? IAppendEntriesRpcResponse :
    P extends 'request-vote' ? IRequestVoteRpcResponse :
    never;
