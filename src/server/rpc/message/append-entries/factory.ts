...
export function createAppendEntriesRpcRequest(args: IAppendEntriesRpcArguments): IAppendEntriesRpcRequest {
    return {
        callType: 'request',
...
export function createAppendEntriesRpcResponse(results: IAppendEntriesRpcResults): IAppendEntriesRpcResponse {
    return {
        callType: 'response',
        procedureType: 'append-entries',
        results
